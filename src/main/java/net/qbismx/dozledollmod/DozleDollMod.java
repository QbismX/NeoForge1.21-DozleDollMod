...
@Mod(DozleDollMod.MODID)
public class DozleDollMod {
    // 他者のスキンを使用しているので、基本的に公開・配布してはいけない
    // Define mod id in a common place for everything to reference
    public static final String MODID = "dozledollmod";
    ...
    @EventBusSubscriber(modid = DozleDollMod.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
